...
`tools/list` at `https://gateway.pipeworx.io/opencellid/mcp` returns the tools in the table
...
```bash
curl -X POST https://gateway.pipeworx.io/v1/tools/get_cell \
  -H 'Content-Type: application/json' \
  -d '{"mcc":310,"mnc":410,"lac":5000,"cell_id":12345678}'
```

No account needed for the first calls. Inspect any tool: `GET https://gateway.pipeworx.io/v1/tools/get_cell`. Find one: `POST https://gateway.pipeworx.io/v1/tools/search_packs` with `{"query":"..."}`.
